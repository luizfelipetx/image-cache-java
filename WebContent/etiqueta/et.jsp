...
<html>
 <head>
        ...
        <title>Skina App - Olhou pro lado negócio fechado - Aplicativo Skina</title>   
    ...
    <body>
        ...
        <div id="etiqueta">
            ...
            <div id="chancela">
                <img src="<%=request.getContextPath()%>/images/chancela_sedex.jpg" id="chancela_img" />
            ...
            <div id="futuro_2d">
                <img src="<%=request.getContextPath()%>/api?type=matrix&cepOrigem=281789217sjkjlajlkdjaljsdajdljlsaxxxxxx" id="futuro_2d_img" />
           ...
           <img src="<%=request.getContextPath()%>/api?type=barcode&amp;tc=2817892178974hh" id="barcode_img" style="">
            <div id="destinatario">
                ...
                <p id="obs">Obs:</p>
                <div id="mini_barcode_img" style="background-image: url( '<%=request.getContextPath()%>/api?type=barcode&amp;tc=281789');"> </div>
                <br style="clear:both" />
            </div>
            <div id="remetente">
                <p><b>Remetente:</b></p>
