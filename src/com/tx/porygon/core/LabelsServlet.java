...
/**
 * Servlet implementation class LabelsServlet
 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("purchaseId")!=null){
			//TestG.generatePDF(request.getParameter("purchaseId"));
			    ...
			    String downalod = "attachment";
			    
			    if(request.getParameter("open")!=null)
			    	downalod = "inline";
			    
			    response.setHeader("Content-disposition", ""+downalod+"; filename="+ fileName+ ".pdf");
